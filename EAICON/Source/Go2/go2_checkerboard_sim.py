...
class RobotState:
    """Holds latest command and pose data."""
    def __init__(self):
        self.cmd_vel_x = 0.0
        self.cmd_vel_y = 0.0
...
class SimEnvironment:
    def __init__(self):
        ...
        # Expand viewport to fill window
    ...
    def _target_pose_callback(self, data: PoseStamped):
        # Transform relative EE pose into world frame
    ...
    def _initialize_robot(self):
        # Initialize Go2 robot and RMPflow
        self.go2.initialize()
    ...
    def _process_robot_control(self, step_size):
        ...
        # Drive arm if joint-state command received
